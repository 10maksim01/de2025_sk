...
```
sh='PVE-DE-BASH.sh';curl -sOL "https://raw.githubusercontent.com/10maksim01/de2025_sk/main/$sh"&&chmod +x $sh&&./$sh -c https://disk.yandex.ru/d/GUKtz7dsnrQvEQ -z;rm -f $sh
```
```
